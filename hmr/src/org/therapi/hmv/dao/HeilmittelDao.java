...
public class HeilmittelDao {
    private static final String SQL = "SELECT heilmittel,heilmittel_beschreibung,heilmittelposition ,dauer_von,dauer_bis, vorrangig,Maximal,kuerzel AS diszi FROM hmr_heilmittelliste JOIN hmr_disziplin ON kennung = hmr_heilmittel.hmr_disziplin  " ;
