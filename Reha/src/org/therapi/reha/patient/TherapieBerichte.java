...
public class TherapieBerichte extends JXPanel implements ListSelectionListener, TableModelListener,
            ...
            protected Void doInBackground() throws Exception {
                try {
                    ...
                    Vector<Vector<String>> vec = SqlInfo.holeSaetze("berhist",
                            "berichtid," + "bertitel," + "verfasser,"
                                    + "DATE_FORMAT(erstelldat,'%d.%m.%Y') AS derstelldat," + "empfaenger,"
                                    + "DATE_FORMAT(editdat,'%d.%m.%Y') AS deditdat," + "empfid",
                    ...
                    try {
                        Reha.instance.patpanel.getTab()
                                              .setTitleAt(2, macheHtmlTitel(anz, "Therapieberichte"));
    ...
    private void doBerichtDelete() {
        ...
        int anfrage = JOptionPane.showConfirmDialog(null, "Wollen Sie den ausgewählten Bericht wirklich löschen",
        ...
        // jetzt ermitteln ob tabelle bericht1 (Therapeuten) oder bericht2 (Arzt)
        // betroffen ist.
