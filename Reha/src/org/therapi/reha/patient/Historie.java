...
/**
 * @DEPRECATED - in 1.1.9 use {@link org.therapi.reha.patient.RezepteHistorisch#RezepteHistorisch(IK)} instead...
 *
 */
@Deprecated public class Historie extends JXPanel implements ActionListener, TableModelListener, PropertyChangeListener {
    ...
    public JXPanel getTabelle() {
        ...
        tabhistorie.getColumn(0)
                   .setMaxWidth(75);
        TableCellRenderer renderer = new DefaultTableRenderer(new MappedValue(StringValues.EMPTY, IconValues.ICON),
                JLabel.CENTER);
        tabhistorie.getColumn(1)
                   .setCellRenderer(renderer);
        tabhistorie.getColumn(1)
                   .setMaxWidth(45);
        tabhistorie.getColumn(2)
                   .setMaxWidth(75);
        tabhistorie.getColumn(3)
                   .setMaxWidth(75);
        tabhistorie.getColumn(5)
                   .setMinWidth(0);
        tabhistorie.getColumn(5)
                   .setMaxWidth(0);
        tabhistorie.getColumn(idInTable)
                   .setMinWidth(0);
        tabhistorie.getColumn(idInTable)
                   .setMaxWidth(0);
    ...
    private void holeEinzelTermine(int row, Vector<?> vvec) {
        Vector<?> xvec = null;
        if (vvec == null) {
            xvec = SqlInfo.holeSatz("lza", "termine", "id='" + tabhistorie.getValueAt(row, idInTable) + "'",
