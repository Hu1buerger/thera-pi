...
public class PatientStammDatenPanel extends JXPanel {
    ...
    public void parseHTML(boolean parse) {
        ...
        try {
            ...
            /***** Rezept ****/
            /*******/
            String linktext = "<img src='file:///" + Path.Instance.getProghome()
                    + "icons/kontact_contacts.png' width=36 height=36 border=0>";
            buf1.append("<tr><td class=\"spalte1\" align=\"left\">" + makeLink(linktext, "FOTO"));
            if (Reha.bRGAFoffen || Reha.bHatMerkmale) {
                buf1.append("&nbsp;&nbsp;");
                buf1.append("<img src='file:///" + Path.Instance.getProghome()
                        + "icons/Icon_Achtung.svg.png' width=48 height=41 border=0>");
            }
            buf1.append("</td></tr>");
            ...
            buf1.append("<tr><td class=\"spalte1\" align=\"left\">");
            buf1.append("<img src='file:///" + Path.Instance.getProghome()
                    + "icons/krankenkasse.png' width=30 height=30 border=0><b>" + "+" + "</b>");
            buf1.append("<img src='file:///" + Path.Instance.getProghome()
            ...
            buf1.append("<tr><td class=\"spalte1\" align=\"left\">");
            buf1.append("<img src='file:///" + Path.Instance.getProghome()
                    + "icons/evolution-addressbook.png' width=32 height=32 border=0>");
            buf1.append("</td></tr>");
    ...
    private String getAkutDaten() {
        ...
        if (patientHauptPanel.patDaten.get(33)
            ...
            buf2.append(makeLink(
                    "Akutpat.: <font color=#FF0000>JA bis "
                            + (dummy.length() == 10 ? DatFunk.sDatInDeutsch(dummy.toString()) : "k.A.") + "</font>",
                    "AKUTBIS"));
            buf2.append("</td></tr>");
        } else {
            buf2.append("<tr><td class=\"spalte1\" align=\"left\">");
    ...
    private String getBefreiungsDaten() {
        ...
        if (dummy.length() == 10) {
            buf3.append("<tr><td class=\"spalte1\" align=\"left\">");
            buf3.append(
                    makeLink("Befreiung bis: <font color=#FF0000><b>" + DatFunk.sDatInDeutsch(dummy) + "</b></font>",
                            "AKUT_DAT"));
            buf3.append("</td></tr>");
        }
        ...
        if (!dummy.equals("")) {
            buf3.append("<tr><td class=\"spalte1\" align=\"left\">");
            buf3.append(makeLink("Vorjahr befreit: <font color=#FF0000><b>"
                    + (dummy.equals(SystemConfig.vorJahr) ? "JA" : "NEIN") + "</b></font>", "VORJAHR"));
            buf3.append("</td></tr>");
        }
    ...
    private String getLeerHtml() {
        ...
        /***** Rezept ****/
        /*******/
        buf2.append("<tr><td class=\"spalte1\" align=\"left\">" + "<img src='file:///" + Path.Instance.getProghome()
    ...
    private JXPanel getStammDatenPanel() { // 1 2 3 4 5 6 7 8
        FormLayout lay = new FormLayout(
                "3dlu,right:max(38dlu;p),3dlu,55dlu:g,3dlu,right:max(39dlu;p),3dlu,45dlu:g,5dlu",
