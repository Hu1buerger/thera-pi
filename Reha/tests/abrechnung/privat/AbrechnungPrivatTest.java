...
new Betriebsumfeld(new Mandant("123456789", "testmandant"));
        ...
        AbrechnungPrivat rg = new AbrechnungPrivat(frame, "privateabrechnung", data.preisgruppe, (JComponent) frame.getGlassPane(),
                preisliste, data.hatAbweichendeAdresse, data.patDBId, patientenDatenVector,
                "123456789", "HMRechnungPrivat.ott", hmAbrechnung, hmPreisGruppen.get(StringTools.getDisziplin(data.rezeptNummer)), new Rezept(rezeptVector)) {
