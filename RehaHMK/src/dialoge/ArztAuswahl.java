...
//PinPanel pinPanel;
    ...
    public void fuelleTabelle(String suchkrit) {
        ...
        Vector<Vector<String>> vec = SqlInfo.holeSaetze("arzt", "nachname,vorname,strasse,ort,arztnum,id", krit,
    ...
    public void fuelleIdTabelle(String suchid) {
        arztwahlmod.setRowCount(0);
        arztwahltbl.validate();
        Vector<Vector<String>> vec = SqlInfo.holeSaetze("arzt", "nachname,vorname,strasse,ort,arztnum,id",
