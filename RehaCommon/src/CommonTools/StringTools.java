...
public class StringTools {
            ...
            for (int y = 0; y < 1; y++) {
                ...
                if ((test.indexOf(" ") < 0) && (test.indexOf("-") < 0) && (test.indexOf("/") < 0)) {
                    ...
                    if (test.indexOf("Mc") > -1) {
                        try {
                            if (test.length() >= 3) {
                                if (!test.substring(2, 3)
                                         .equals(" ")) {
                                    test = "Mc" + test.substring(2, 3)
                                                      .toUpperCase()
                                            + test.substring(3)
                                                  .toLowerCase();
                                }
                    ...
                    /*
                     * if(test.indexOf("Mac") > -1){ try{ if(test.length() >=4){
    ...
    /**checks whether a string is convertable to Integer.
     * @param string the String to be tested
     * @return -1 if not an Integer or the int represented by the String.
     */
