...
public class DatenbankTab extends JXPanel implements ChangeListener {
    ...
    DatenbankTab() {
        ...
        tab2.setName("Seite2");
        sqlTab.add(
                "<html><font size='5' >&nbsp;2 - <font color='e77817'>Thera-Pi</font> Datenbank erstellen&nbsp;<img src='file:///"
                        + TheraPiDbAdmin.proghome + "icons/application-exit.png' width='32' height='32'></font></html>",
                tab2);
        tab3 = new Seite3(this);
        tab3.setName("Seite3");
        sqlTab.add(
                "<html><font size='5' >&nbsp;3 -  <font color='e77817'>Thera-Pi</font> Tabellen importieren&nbsp;<img src='file:///"
                        + TheraPiDbAdmin.proghome + "icons/application-exit.png' width='32' height='32'></font></html>",
                tab3);
        tab4 = new MyErstInstall(this);
        tab4.setName("Seite4");
        sqlTab.add(
                "<html><font size='5' >&nbsp;4 -  <font color='e77817'>Thera-Pi</font> Eigene Firma (IK) einrichten&nbsp;<img src='file:///"
                        + TheraPiDbAdmin.proghome + "icons/application-exit.png' width='32' height='32'></font></html>",
                tab4);
    ...
    public void setSeite2Ok(boolean ok) {
        if (ok) {
            ...
            sqlTab.setTitleAt(1,
                    "<html><font size='5' >&nbsp;2 - <font color='e77817'>Thera-Pi</font> Datenbank erstellen&nbsp;<img src='file:///"
                            + TheraPiDbAdmin.proghome
                            + "icons/application-exit.png' width='32' height='32'></font></html>");
    ...
    private void doHeader() {
        ...
        vectitel.add(
                "<html><font size='5'>Datenbank für <font color='e77817'>Thera-Pi</font> einrichten</font></html>");
        vecdescript.add(
                "<html>Jetzt legen Sie die eigentliche Datenbank, sowie einen Datenbankbenutzer und dessen Passwort an.<br>Gehen Sie hierfür wie folgt vor:<br>"
